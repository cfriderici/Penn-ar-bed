...
const SocialAppContextProvider = ({ children }) => {
    ...
    const [ LOCAL_STORAGE_KEY, user, setUser, token, setToken, userData, setUserData, registerUser, logoutUser, editUserData, reloadUserData ] = useAuth();
            ...
            value={
                {
                    ...
                    user, setUser, token, setToken, userData, setUserData, registerUser, logoutUser, editUserData, reloadUserData
                }
            } 
        >
            {children}
